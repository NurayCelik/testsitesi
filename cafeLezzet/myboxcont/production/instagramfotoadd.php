...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit']) ) {  
        $insertedinstagramgaleri = $page->galeriInstagramInsert($_POST, $_FILES);
  ...
  <div class="">
    <div class="page-title">
      <div class="title_left">
        ...
        <?php 
            if (isset($insertedinstagramgaleri)) {
                 echo $insertedinstagramgaleri;
              }
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            <div class="x_title">
              <h2>İnstagram Foto Ekle<small>
               </small> </h2>
                <ul class="nav navbar-right panel_toolbox">

                  <a href="instagramfoto.php"><button type="submit" name="back" class="btn btn-info btn-sm"><i class="fa fa-undo"></i> Vazgeç</button></a>
