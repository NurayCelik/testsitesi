...
<head>
  ...
  <title>Anka Yazilim Yönetim Paneli </title>
        ...
        <section class="login_content">
          <form action="" method="POST">
            ...
            <div class="separator">
              ...
              <div>
                <h1><i class="fa fa-gears"></i> Anka Yazilim</h1>
                <p>©2019 Anka Yazılım tarafından kodlanmıştır.</p>
              </div>
            </div>
          </form>
        </section>
        ...
        <section class="login_content">
          <form>
            ...
            <div class="separator">
              ...
              <div>
                <h1><i class="fa fa-gears"></i> Gentelella Alela!</h1>
